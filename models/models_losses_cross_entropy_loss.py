...
from models.models_builder import LOSSES
from models.models_losses_utils import weight_reduce_loss


def cross_entropy(
    pred, label, weight=None, reduction="mean", avg_factor=None, class_weight=None
):
...
def binary_cross_entropy(
    ...
    loss = F.binary_cross_entropy_with_logits(
        pred, label, weight=class_weight, pos_weight=pos_weight, reduction="none"
    )
