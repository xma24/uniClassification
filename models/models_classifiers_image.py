...
from models.models_builder import CLASSIFIERS, build_backbone, build_head, build_neck
from models.models_classifiers_base import BaseClassifier
from models.models_utils_augment_augments import Augments
from models.models_heads_multi_label_head import MultiLabelClsHead
    ...
    def simple_test(self, img, img_metas=None, **kwargs):
        ...
        if isinstance(self.head, MultiLabelClsHead):
            assert "softmax" not in kwargs, (
                "Please use `sigmoid` instead of `softmax` " "in multi-label tasks."
            )
